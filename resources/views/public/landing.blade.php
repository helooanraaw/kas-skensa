...
{{-- HERO SECTION --}}
{{-- HERO SECTION: Bagian Utama (Hero) yang pertama kali dilihat user --}}
{{-- Container utama hero dengan background warna biru gelap custom --}}
<div class="position-relative w-100" style="background-color: var(--skensa-dark-blue); margin-top: -1px; padding-top: 6rem; padding-bottom: 14rem; color: white;">
    ...
    <div class="container position-relative z-1">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-5 mb-lg-0 animate from-left hero-stagger" data-stagger="90">
                ...
                {{-- Judul Utama Halaman --}}
                <h1 class="display-3 fw-bold mb-4" style="line-height: 1.1; color: #fff; font-size: clamp(3.5rem, 6vw, 4rem);">
                    OpenKas Skensa,<br>
                    {{-- Span untuk memberi warna biru muda pada teks sub-judul --}}
                ...
                {{-- Tombol CTA (Call to Action) menuju daftar kelas --}}
            ...
            {{-- Kolom Kanan: Gambar Preview Dashboard (Hanya muncul di layar besar/desktop) --}}
            <div class="col-lg-6 text-center animate from-right d-none d-lg-block">
                <div class="position-relative">
                    {{-- Container gambar dengan efek 3D perspective --}}
    ...
    {{-- Elemen dekoratif: Gradasi pudar di bagian bawah hero untuk transisi halus ke section berikutnya --}}
...
{{-- DAFTAR KELAS SECTION: Menampilkan list semua kelas yang tersedia --}}
{{-- Container dibuat overlapping ke atas (negatif margin) agar menyatu dengan hero --}}
<div id="daftar-kelas" class="container animate from-bottom" style="margin-top: -8rem; position: relative; z-index: 10;">
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-white">
        {{-- Header Card: Judul Section --}}
        ...
        {{-- Body Card: List Tombol Kelas --}}
        <div class="card-body p-4">
            <div class="row g-2">
                {{-- Loop data kelas dari database --}}
                @foreach($classes as $class)
                    <div class="col-6 col-md-3 col-lg-2">
                        {{-- Link menuju halaman detail kas per kelas --}}
...
{{-- TOP GLOBAL PAYERS: List siswa dengan pembayaran terbanyak (Leaderboard) --}}
<div id="top-payers" class="container mt-4 animate from-bottom">
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-white">
        ...
        <div class="card-body p-3">
            {{-- Cek apakah ada data top payers --}}
            @if(isset($topPayers) && $topPayers->count())
                <div class="list-group">
                    @foreach($topPayers as $payer)
                        {{-- Button item list yang bisa diklik untuk detail --}}
...
{{-- LATAR BELAKANG & STATS SECTION: Penjelasan kenapa sistem ini dibuat dan statistik singkat --}}
<div id="literasi" class="py-5 mt-5 bg-white">
    <div class="container py-4">
        <div class="row align-items-center">
            {{-- Kolom Kiri: Teks Penjelasan Latar Belakang --}}
            <div class="col-lg-5 mb-4 mb-lg-0 animate from-left stagger-row">
                {{-- Badge Judul Kecil --}}
                <div class="d-inline-flex align-items-center border border-primary border-opacity-10 rounded-pill px-3 py-1 mb-4 bg-primary bg-opacity-5 backdrop-blur">
                    <span class="badge bg-primary text-white rounded-pill me-2">LATAR BELAKANG</span>
                    <!-- <small class="fw-bold text-primary letter-spacing-1 text-uppercase">Latar Belakang</small> -->
                </div>
                {{-- Judul Besar --}}
                <h2 class="fw-bold mb-4 display-6" style="color: var(--skensa-dark-blue);">Mengapa Sistem Ini<br>Sangat Penting?</h2>
                
                {{-- Paragraf penjelasan masalah --}}
            ...
            {{-- Kolom Kanan: Statistik Angka (Grid 2x2 atau variasi) --}}
            <div class="col-lg-6 offset-lg-1 animate from-right stagger-row">
                <div class="row g-3">
                    ...
                    {{-- Stat 3: Keamanan Data (Full Width) --}}
                    <div class="col-12">
...
{{-- CARA KERJA SISTEM SECTION: Menjelaskan alur penggunaan aplikasi --}}
    ...
    <div class="container py-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4 text-center position-relative">
                ...
                {{-- Arrow/garis putus-putus sebagai penghubung visual (hanya di desktop) --}}
...
{{-- FITUR & KEUNGGULAN SECTION: Menampilkan fitur-fitur utama aplikasi --}}
...
{{-- VISI JANGKA PANJANG SECTION: Misi dan tujuan jangka panjang pengembang --}}
...
{{-- FOOTER: Bagian kaki halaman yang berisi informasi navigasi dsb --}}
